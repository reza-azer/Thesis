...
void setup() {
  ...
  Serial.println(F(" ______  __  __   ______  ______   ______   ______   ______   __   ______   __   __           "));  
  Serial.println(F("/\\  ___\\/\\_\\_\\_\\ /\\  == \\/\\  == \\ /\\  ___\\ /\\  ___\\ /\\  ___\\ /\\ \\ /\\  __ \\ /\\  -.\\ \\          "));  
  Serial.println(F("\\ \\  __\\\\/_/\\_\\/_\\ \\  _-/\\ \\  __< \\ \\  __\\ \\ \\___  \\\\ \\___  \\\\ \\ \\\\ \\ \\/\\ \\\\ \\ \\-.  \\         "));  
  Serial.println(F(" \\ \\_____\\/\\_\\/\\_\\\\ \\_\\   \\ \\_\\ \\_\\\\ \\_____\\\\/\\_____\\\\/\\_____\\\\ \\_\\\\ \\_____\\\\ \\_\\\\ \\_\\        "));  
  Serial.println(F("  \\/_____/\\/_/\\/_/ \\/_/    \\/_/ /_/ \\/_____/ \\/_____/ \\/_____/ \\/_/ \\/_____/ \\/_/ \\/_/        "));    
  Serial.println(F(" ______   ______   ______   ______   ______   __   __   __   ______  __   ______   __   __    "));  
  Serial.println(F("/\\  == \\ /\\  ___\\ /\\  ___\\ /\\  __ \\ /\\  ___\\ /\\  -.\\ \\ /\\ \\ /\\__  _\\/\\ \\ /\\  __ \\ /\\  -.\\ \\   "));  
  Serial.println(F("\\ \\  __< \\ \\  __\\ \\ \\ \\____\\ \\ \\/\\ \\\\ \\ \\__ \\\\ \\ \\-.  \\\\ \\ \\\\/_/\\ \\/\\ \\ \\\\ \\ \\/\\ \\\\ \\ \\-.  \\  ")); 
  Serial.println(F(" \\ \\_\\ \\_\\\\ \\_____\\\\ \\_____\\\\ \\_____\\\\ \\_____\\\\ \\_\\\\ \\_\\\\ \\_\\  \\ \\_\\ \\ \\_\\\\ \\_____\\\\ \\_\\\\ \\_\\ ")); 
  Serial.println(F("  \\/_/ /_/ \\/_____/ \\/_____/ \\/_____/ \\/_____/ \\/_/ \\/_/ \\/_/   \\/_/  \\/_/ \\/_____/ \\/_/ \\/_/ "));
  Serial.println(F("> Sketch uses 219768 bytes (96%) of program storage space. Maximum is 253952 bytes. \n> Global variables use 6574 bytes (79%) of dynamic memory, leaving 1646 bytes for local variables. Maximum is 8192 bytes."));
  Serial.println(F(""));
...
void cek(String ekspresi)
{
  ...
  for (int i = 0; i < data_baris; i++) {
    // Serial.print(F(">")); //memunculkan loading
